                            ...
                            <tbody>
                                {ListCart.map((item, key) => {
                                    return (
                                        <tr key={key}>
                                            <TableData>
                                                <HighlightOffIcon onClick={() => DeleteCart(key)} style={{cursor: 'pointer', transform: 'translateY(-4px)'}}></HighlightOffIcon>
                                            </TableData>
                                            ...
                                            <TableData style={{minWidth: '150px'}}>
                                                <ButtonInCart style={{margin: '2px'}} onClick={() => DecreaseQuantity(key)}>
                                                    -
                                                </ButtonInCart>
                                                <ButtonInCart>{item.quantity}</ButtonInCart>
                                                <ButtonInCart style={{margin: '2px'}} onClick={() => IncreaseQuantity(key)}>
                                                    +
                                                </ButtonInCart>
                                            </TableData>
