                ...
                <AddressSelector>
                    <SelectorHeader>
                        ...
                        <SelectorLabel
                            ...
                            className={`${active === 2 ? 'active' : ''} ${province == '' ? 'disabled' : ''}`}
                        >
                            Quận/Huyện
                        </SelectorLabel>
                        <SelectorLabel
                            ...
                            className={`${active === 3 ? 'active' : ''} ${district == '' ? 'disabled' : ''}`}
                        ...
                        <SelectorBody>
                            {listProvince.length > 0 &&
                                listProvince.map((item, index) => (
                                    <SelectorItem
                                        className={item == province ? 'active' : ''}
                                        key={index}
                                        onClick={() => {
                                            setProvince(item);
                                            setDistrict({});
                        ...
                        <SelectorBody>
                            {listDistrict.length > 0 &&
                                listDistrict.map((item, index) => (
                                    <SelectorItem
                                        className={item.name == district.name ? 'active' : ''}
                                        key={index}
                                        onClick={() => {
                                            setDistrict({...item});
                                            setWard({});
                        ...
                        <SelectorBody>
                            {listWard.length > 0 &&
                                listWard.map((item, index) => (
                                    <SelectorItem
                                        className={item.name == ward.name ? 'active' : ''}
                                        key={index}
                                        onClick={() => {
                                            setWard({...item});
                                        }}
